<div class="index-dossier col__2--exclude-phone col__1--phone h430--exclude-phone">
	...
	<? req_with_param(PATH__PHP_LEGO_COMMON . "/btn.php", ["text" => "Досье", "class" =>
		"btn--brand"]); ?>
	...
	<div class="index-dossier__wrapper-short-announcements">
		...
		<? req_with_param(PATH__PHP_LEGO_COMMON . "/short-announcement.php", ["title" => "Трагедия в Альпах – что творилось в голове у пилота?", "img" => "/common/short-announcement-1.jpg", "width" => "short"]); ?>
